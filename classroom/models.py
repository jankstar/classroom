...
class Raum(models.Model):    
    ...
    von = models.DateField(verbose_name= _(u"verfügbar ab"), blank=True, null=True)
    bis = models.DateField(verbose_name= _(u"verfügbar bis"), blank=True, null=True)
...
class Dozent(models.Model):
    ...
    von = models.DateField(auto_now=False, help_text= _(u"Dozent ist verfügbar von/bis"), blank=True, null=True)
...
class Teilnehmer(models.Model):
    ...
    id_kunde = models.ForeignKey(Kunde)
    id_user = models.ForeignKey(User)
    von = models.DateField(auto_now=False, help_text= _(u"Teilnehmer ist verfügbar von/bis"), blank=True, null=True)
    bis = models.DateField(auto_now=False, blank=True, null=True)
